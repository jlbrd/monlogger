...
//static const mode_t S_IRUSR      = 0x0100; //mode_t(_S_IREAD);     ///< read by user
//static const mode_t S_IWUSR      = 0x0080; //mode_t(_S_IWRITE);    ///< write by user
//static const mode_t S_IXUSR      = 0x00400000;           ///< does nothing
#   ifndef STRICT_UGO_PERMISSIONS
//static const mode_t S_IRGRP      = 0x0100; // mode_t(_S_IREAD);     ///< read by *USER*
//static const mode_t S_IWGRP      = 0x0080; // mode_t(_S_IWRITE);    ///< write by *USER*
//static const mode_t S_IXGRP      = 0x00080000;           ///< does nothing
//static const mode_t S_IROTH      = 0x0100; // mode_t(_S_IREAD);     ///< read by *USER*
//static const mode_t S_IWOTH      = 0x0080; // mode_t(_S_IWRITE);    ///< write by *USER*
